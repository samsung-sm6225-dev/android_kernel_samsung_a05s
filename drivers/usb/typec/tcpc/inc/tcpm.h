...
extern uint8_t tcpm_get_pd_connect_state(struct tcpc_device *tcpc);
extern uint8_t tcpm_get_pd_connect_type(struct tcpc_device *tcpc);
...
static uint8_t tcpm_get_pd_connect_state(struct tcpc_device *tcpc)
{
	return TCPM_ERROR_NO_IMPLEMENT;
}
